...
{
    std::ifstream in("/Users/den4ick800/car_traffic_model/modeling_information.txt");
...
void car::accident(object& a,object& b){
    ...
    boom->setOpacity(0.6);
    delete_from_moving(a);
     delete_from_moving(b);
}
...
void car::delete_from_moving(object& a){
